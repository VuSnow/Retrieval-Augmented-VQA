...
local vqa_data = {
  "question_files":{
    "train": '../data/RAVQA_v2_data/okvqa/OpenEnded_mscoco_train2014_questions.json',
    "test": '../data/RAVQA_v2_data/okvqa/OpenEnded_mscoco_val2014_questions.json',
  },
  "annotation_files": {
    "train": '../data/RAVQA_v2_data/okvqa/mscoco_train2014_annotations.json',
    "test": '../data/RAVQA_v2_data/okvqa/mscoco_val2014_annotations.json',
  },
};
local VinVL_features = {
  "train": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/vinvl_output/vinvl_okvqa_trainset_full/inference/vinvl_vg_x152c4/predictions.tsv",
  "test": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/vinvl_output/vinvl_okvqa_testset_full/inference/vinvl_vg_x152c4/predictions.tsv",
};
local img_data = {
  "train": "../data/RAVQA_v2_data/okvqa/train2014",
  "test": "../data/RAVQA_v2_data/okvqa/val2014",
};
local ocr_features = {
  "train": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/OCR/train",
  "test": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/OCR/valid",
  "combine_with_vinvl": true,
};
local caption_features = {
  "train": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/captions/train_predictions.json",
  "valid": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/captions/valid_predictions.json",
  "test": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/captions/test_predictions.json",
};
local passage_data = {
  "train": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/passages/okvqa_train_corpus.csv",
  "full": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/passages/okvqa_full_corpus.csv",
};
...
local dpr_training_annotations = {
  "train": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/passages/retriever_train.json",
  "valid": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/passages/retriever_testdev.json",
  "test": "../data/RAVQA_v2_data/okvqa/pre-extracted_features/passages/retriever_test.json",
};
...

{
  ...
  "WANDB": {
    ...
    "entity": "vm-dung-learning-hanoi-university-of-science-and-technology",
    "project": "RAVQA",
    "tags": ["OKVQA"],
  },
